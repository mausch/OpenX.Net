...
namespace OpenXNet {
    public partial class SessionImpl {
        ...
        public AdvertiserCampaignStats[] GetManagerCampaignStatistics(int managerId, DateTime startDate, DateTime endDate) {
        ...
        public PublisherZoneStats[] GetManagerZoneStatistics(int managerId, DateTime startDate, DateTime endDate) {
